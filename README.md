...
1. See ArduinoCircuit_PM25_LED.txt , ArduinoCircuit_PM25_Monitor.txt for circuit connections for this project
...
6. (optional) [EYESPI Connector and TFT 1.8 Display](https://learn.adafruit.com/1-8-tft-display/eyespi)
...
Using an Arduino (or presumably other microcontroller tools),this turns on an LED light once a certain threshold of PM 2.5 is crossed, or displays values on a simple TFT monitor. Currently hard-coded for Unhealthy for Sensitive Groups level
